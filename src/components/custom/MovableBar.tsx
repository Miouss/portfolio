  ...
  useEffect(() => {
    if (mouseIsPressed) {
      ...
      return () => {
        ...
        if (windowPos.top < 0 || windowPos.bottom > 1080) {
      ...
      setOriginalOffset({left: windowBarRef.current!.offsetParent!.offsetLeft + "px", top: windowBarRef.current!.offsetParent!.offsetTop + "px"})
    }
